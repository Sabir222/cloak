...
In Claude Code, the role-based reviewers in `personas/` start with isolated context by design and are usable here — see `personas/` for the roster and per-domain match.
